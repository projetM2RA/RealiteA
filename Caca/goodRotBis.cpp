    ...
    */
    ...
    do
    {
        ...
        else if(!images.empty())
        {
            ...
            //std::cout << "t1 = " << -tvecs.at<double>(0, 0) << " ; t2 = " << t2 << " ; t3 = " << tvecs.at<double>(1, 0) << " ; correcteurX = " << correcteurX << std::endl;
...
//          std::cout << "rotX = " << (rotX*180)/PI << " ; rotY = " << (rotY*180)/PI << " ; rotZ = " << (rotZ*180)/PI << std::endl;
            ...
            osg::Matrixd matrix180Z; // rotation de repere entre opencv et osg
            matrix180Z.makeRotate(osg::Quat(osg::DegreesToRadians(180.0f), osg::Vec3d(0.0, 0.0, 1.0)));

            osg::Matrixd matrix180Y; // rotation de repere entre opencv et osg
            matrix180Y.makeRotate(osg::Quat(osg::DegreesToRadians(180.0f), osg::Vec3d(0.0, 1.0, 0.0)));

            mat->setMatrix(matrixR2 * matrixT * matrix90 * matrix180Z);
        }
